...
static int property_imgparams(struct mp_image_params p, int action, void *arg)
{
    ...
    struct m_sub_property props[] = {
        ...
        {"colormatrix",
            SUB_PROP_STR(m_opt_choice_str(mp_csp_names, p.color_repr.sys))},
        {"colorlevels",
            SUB_PROP_STR(m_opt_choice_str(mp_csp_levels_names, p.color_repr.levels))},
        {"primaries",
            SUB_PROP_STR(m_opt_choice_str(mp_csp_prim_names, p.color_space.primaries))},
        {"gamma",
            SUB_PROP_STR(m_opt_choice_str(mp_csp_trc_names, p.color_space.transfer))},
        {"sig-peak", SUB_PROP_FLOAT(p.color_space.sig_peak)},
        {"light",
            SUB_PROP_STR(m_opt_choice_str(mp_csp_light_names, p.color_space.light))},
        {"chroma-location",
